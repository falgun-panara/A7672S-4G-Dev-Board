    ...
    while (1)
    {
        ...
        switch (opt)
        {
            case SC_FTPS_DEMO_INIT:
            {
                ...
                sAPI_Debug("SRV = [%d],msgId = [%d],api = [%d],errCode = [%d]", channeltype, ftpsMsg.msg_id, ftpsMsg.arg1,
                           ftpsMsg.arg2);
            ...
            case SC_FTPS_DEMO_LOGIN:
            {
                ...
                PrintfResp("\r\nPlease input Ip.\r\n");
                UartReadLine(msg.host, 256);

                PrintfResp("\r\nPlease input Port.\r\n");
                msg.port = UartReadValue();


                PrintfResp("\r\nPlease input User.\r\n");
                UartReadLine(msg.username, 256);

                PrintfResp("\r\nPlease input Pass.\r\n");
                UartReadLine(msg.password, 256);
            ...
            case SC_FTPS_DEMO_DELETEFILE:
            {
                ...
                UartReadLine(file, 100);
                sAPI_Debug("file = [%s]", file);
