...
static sc_spi_lcd_write_t lcd_st7789v_spi_init_data_240_240_SZGMD[] =
{
    {SC_LCD_DELAY, 120, 0},
    {SC_LCD_CMD, 0x11, 0},
    {SC_LCD_DELAY, 120, 0},
    ...
    {SC_LCD_CMD,  0xB7, 1},
    {SC_LCD_DATA, 0x00, 0},//VGH=12.2V,VGL=-7.16V
    ...
    {SC_LCD_CMD,  0xC3, 1},
    {SC_LCD_DATA, 0x0F, 0},  //4.3V 

    {SC_LCD_CMD,  0xC4, 1},
    {SC_LCD_DATA, 0x20, 0}, //VDV, 0x20:0v
    ...
    {SC_LCD_CMD,  0xD6, 1},
    {SC_LCD_DATA, 0xA1, 0}, //sleep in后，gate输出为GND
    ...
    {SC_LCD_CMD,  0xE4, 3},
    {SC_LCD_DATA, 0x1D, 0}, //使用240根gate  (N+1)*8
    {SC_LCD_DATA, 0x00, 0}, //设定gate起点位置
    {SC_LCD_DATA, 0x00, 0}, //当gate没有用完时，bit4(TMG)设为0
    ...
    {SC_LCD_CMD,  0x2A, 4}, //Column Address Set
    {SC_LCD_DATA, 0x00, 0},
    {SC_LCD_DATA, 0x00, 0},
    {SC_LCD_DATA, 0x00, 0},
    {SC_LCD_DATA, 0xEF, 0}, 

    {SC_LCD_CMD,  0x2B, 4},  //Row Address Set
    {SC_LCD_DATA, 0x00, 0},
    {SC_LCD_DATA, 0x00, 0},
    {SC_LCD_DATA, 0x00, 0},
    {SC_LCD_DATA, 0xEF, 0}, 
...
static sc_lcd_data_t lcd_st7789v_spi_data_240_240_SZGMD = {
    .init_para = lcd_st7789v_spi_init_data_240_240_SZGMD,
    .init_para_len = sizeof(lcd_st7789v_spi_init_data_240_240_SZGMD)/sizeof(sc_spi_lcd_write_t),
    .width = 240,
    .height = 240,
    .te_signal = SC_LCD_CAP_NOTE,
    .spi_clk = SC_SPI_LCD_CLK_26M,
...
static sc_lcd_data_t *lcd_list[7] = {
    ...
    &lcd_st7789v_spi_data_240_240_SZGMD,
};
...
{{"卡"},{0x00,0x40,0x40,0x40,0x40,0x40,0x40,0xFF,0xFE,0x48,0x48,0x48,0x4C,0x48,0x60,0x40,
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFF,0x7F,0x01,0x02,0x06,0x1C,0x08,0x00,0x00}},
{{"片"},{0x00,0x00,0x00,0xFE,0xFC,0x10,0x10,0x10,0x10,0x1F,0x1E,0x90,0x10,0x10,0x18,0x10,
