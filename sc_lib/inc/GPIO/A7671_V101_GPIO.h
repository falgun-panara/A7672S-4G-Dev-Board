#ifndef __A7671_V101_GPIO_H__
#define __A7671_V101_GPIO_H__

#ifdef __cplusplus
extern "C" {
#endif

/* A7671_V101 GPIO Resource Sheet  */
typedef enum {
    SC_MODULE_GPIO_NOT_ASSIGNED = -1,

    SC_MODULE_GPIO_00 = 4,   /*  pin4, pad name: RI  */
    SC_MODULE_GPIO_01 = 73,   /*  pin5, pad name: GPIO_01/USIM2_CLK*/
    ...
    SC_MODULE_GPIO_05 = 56,  /*  pin19, pad name: GPIO_05/32k_out  */
#if !defined (SC_DRIVER_GNSS_CC1161W) || !defined (SC_DRIVER_GNSS_CC1177W)
    SC_MODULE_GPIO_06 = 84,  /*  pin20, pad name: GPIO_06/MK_IN_3  */
#endif
    ...
    SC_MODULE_GPIO_11 = 85,   /*  pin67, pad name: GPIO_11/VCXO_REQ  */
    SC_MODULE_GPIO_12 = 74,   /*  pin68, pad name: GPIO_12/USIM2_DATA  */
    SC_MODULE_GPIO_13 = 11,   /*  pin35, pad name: GPIO_13/I2C2_SDA  */
    SC_MODULE_GPIO_14 = 10,   /*  pin36, pad name: GPIO_14/I2C2_SCL  */
    SC_MODULE_GPIO_15 = 86,  /*  pin44, pad name: GPIO_15/VCXO_OUT  */
    SC_MODULE_GPIO_16 = 8,   /*  pin47, pad name: GPIO_16/LCD_RST  */
